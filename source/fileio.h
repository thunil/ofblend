...
template <class T>
void writeGrid4dUni(const std::string &name, Grid4d<T> *grid);
template <class T>
void readGrid4dUni(const std::string &name, Grid4d<T> *grid,
                   int readTslice = -1, Grid4d<T> * slice = NULL,
...
void getUniFileSize(const std::string &name, int &x, int &y, int &z,
                    int *t = NULL);
