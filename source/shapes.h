...
PYTHON() class Shape : public PbClass
{
  public:
	...
	PYTHON() void applyToGridSmooth(GridBase *grid, Real sigma = 1.0,
	                                Real shift = 0, FlagGrid *respectFlags = 0);
...
{
  public:
	PYTHON() Box(FluidSolver *parent, Vec3 center = Vec3::Invalid,
	             Vec3 p0 = Vec3::Invalid, Vec3 p1 = Vec3::Invalid,
...
{
  public:
	PYTHON() Sphere(FluidSolver *parent, Vec3 center, Real radius,
...
// plane is specified by two angles and an offset on the y axis in (offset
// vector would be ( 0, offset, 0) )
// the two angles are specified in degrees, between: y-axis and x-axis
//                                                   y-axis and z-axis
PYTHON() class Slope : public Shape
{
  public:
	PYTHON() Slope(FluidSolver *parent, Real anglexy, Real angleyz, Real origin,
	               Vec3 gs);
