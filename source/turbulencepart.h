...
struct TurbulenceParticleData
{
	TurbulenceParticleData()
	    : pos(0.0), color(1.), tex0(0.0), tex1(0.0), flag(0)
	{
	}
...
//! Turbulence particles
PYTHON() class TurbulenceParticleSystem
    : public ParticleSystem<TurbulenceParticleData>
{
  public:
	PYTHON()
	...
	PYTHON() void synthesize(FlagGrid &flags, Grid<Real> &k, int octaves = 2,
	                         Real switchLength = 10.0, Real L0 = 0.1,
	                         Real scale = 1.0, Vec3 inflowBias = 0.0);
