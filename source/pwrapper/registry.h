...
typedef PyObject *(*GenericFunction)(PyObject *self, PyObject *args,
                                     PyObject *kwds);
...
{
	//! register method
	Register(const std::string &className, const std::string &funcName,
	...
	Register(const std::string &className, const std::string &property,
	         Getter getter, Setter setter);
	//! register class
	Register(const std::string &className, const std::string &pyName,
